...
CREATE SEQUENCE employee_id_seq START WITH 5248 INCREMENT BY 1;
SELECT employee_id_seq.NEXTVAL FROM dual;
    

SELECT * FROM employee_details e JOIN department_details d ON e.department_id = d.department_id;
